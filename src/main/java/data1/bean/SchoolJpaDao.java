...
import data1.event.StudentCoursePayload;
import data1.model.BaseEntity;
import data1.model.Course;
import data1.model.Person;
import data1.model.Student;
import data1.model.Teacher;
import data1.qualifier.DataRepository;
import data1.qualifier.StudentAdded;
import data1.qualifier.StudentRemoved;
...
public class SchoolJpaDao implements SchoolDao {
	...
	/* (non-Javadoc)
	 * @see data1.bean.SchoolDao#searchStudents(data1.bean.SearchCriteria, int, int)
	 */
	@SuppressWarnings("unchecked")
	@Override
